...
export function appendCheckbox(root, label, isReadonly, isChecked, onClick) {
...
const configuration = {
	...
	steps: {
		...
		iconUrlProvider: (_, type) => {
			return `/assets/images/workflow/icon-${type}.svg`
		},
	},
...
designer = Designer.create(placeholder, initialState.definition, configuration);
