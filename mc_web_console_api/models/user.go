...
type User struct {
	...
	Namespaces           Namespaces      `has_many:"namespace"`
	UserLevel            string          `json:"user_level" db:"user_level"` // 사용자 등급에 따른 namespace 관리
	Password             string          `json:"-" db:"-"`
	PasswordConfirmation string          `json:"-" db:"-"`
	UserNamespaces       UserNamespaces  `has_many:"user_namespaces"`
	UserCredentials      UserCredentials `has_many:"user_credential"`
	DefaultCredential    string          `json:"default_credential" db:"default_credential"`
}
...
func (u *User) ValidateUpdate(tx *pop.Connection) (*validate.Errors, error) {
	spew.Dump("=====validateupdate running====")
