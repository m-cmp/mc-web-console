...
func (c *Credential) Create(tx *pop.Connection) (*validate.Errors, error) {
...
func (c *Credential) ValidateUpdate(tx *pop.Connection) (*validate.Errors, error) {
	...
	var err error
	return validate.Validate(
		&validators.StringIsPresent{Field: c.CredentialName, Name: "CredentialName"},
	), err
	//return validate.NewErrors(), nil
}

func (c *Credential) Update(tx *pop.Connection) (*validate.Errors, error) {
