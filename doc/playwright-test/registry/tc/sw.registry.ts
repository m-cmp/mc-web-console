...
export const SW_TC_REGISTRY: TCEntry[] = [
  ...
  { id: 'TC-APP-APPS-03', domain: 'sw', feature: 'APP-APPS', title: '운영 액션 (restart·stop·uninstall)', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/sw/TC-APP-APPS-03-운영-액션-restart-stop-uninstall.spec.ts' },
  { id: 'TC-APP-APPS-04', domain: 'sw', feature: 'APP-APPS', title: '평점 제출', status: 'ready', channel: 'ui', specFile: 'mc-web-console/specs/sw/TC-APP-APPS-04-rating-제출.spec.ts' },

  // ── APP-CAT (7) ──────────────────────────────────────────────────────────
  { id: 'TC-APP-CAT-01', domain: 'sw', feature: 'APP-CAT', title: '빌트인 Catalog 목록 표시', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/sw/TC-APP-CAT-01-빌트인-catalog-목록-표시.spec.ts' },
  { id: 'TC-APP-CAT-02', domain: 'sw', feature: 'APP-CAT', title: 'Catalog 상세 펼침·접힘', status: 'ready', channel: 'ui', specFile: 'mc-web-console/specs/sw/TC-APP-CAT-02-catalog-상세-펼침-접힘.spec.ts' },
  { id: 'TC-APP-CAT-03', domain: 'sw', feature: 'APP-CAT', title: '외부 검색 결과 표시', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/sw/TC-APP-CAT-03-외부-검색-결과-표시.spec.ts' },
  { id: 'TC-APP-CAT-04', domain: 'sw', feature: 'APP-CAT', title: '외부 검색 결과 업로드', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/sw/TC-APP-CAT-04-외부-검색-결과-업로드.spec.ts' },
  { id: 'TC-APP-CAT-05', domain: 'sw', feature: 'APP-CAT', title: 'Catalog 신규 등록', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/sw/TC-APP-CAT-05-catalog-신규-등록.spec.ts' },
  { id: 'TC-APP-CAT-06', domain: 'sw', feature: 'APP-CAT', title: 'Catalog 수정', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/sw/TC-APP-CAT-06-catalog-수정.spec.ts' },
  { id: 'TC-APP-CAT-07', domain: 'sw', feature: 'APP-CAT', title: 'Catalog 삭제', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/sw/TC-APP-CAT-07-catalog-삭제.spec.ts' },
