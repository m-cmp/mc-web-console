...
export const CSP_TC_REGISTRY: TCEntry[] = [
  ...
  // ── CREDENTIAL (4) ───────────────────────────────────────────────────────
  { id: 'TC-CSP-CREDENTIAL-01', domain: 'csp', feature: 'CREDENTIAL', title: 'CSP 자격증명 목록 조회', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/csp/TC-CSP-CREDENTIAL-01-list-credentials.spec.ts' },
  { id: 'TC-CSP-CREDENTIAL-02', domain: 'csp', feature: 'CREDENTIAL', title: 'CSP 자격증명 단건 조회', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/csp/TC-CSP-CREDENTIAL-02-get-credential.spec.ts' },
  { id: 'TC-CSP-CREDENTIAL-03', domain: 'csp', feature: 'CREDENTIAL', title: 'CSP 자격증명 생성', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/csp/TC-CSP-CREDENTIAL-03-create-credential.spec.ts' },
  { id: 'TC-CSP-CREDENTIAL-04', domain: 'csp', feature: 'CREDENTIAL', title: 'CSP 자격증명 삭제', status: 'ready', channel: 'api+ui', specFile: 'mc-web-console/specs/csp/TC-CSP-CREDENTIAL-04-delete-credential.spec.ts' },
