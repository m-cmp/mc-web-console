...
var webconsoleIframeRender *render.Engine // 기본 User 를 위한 iframe Render
...
func init() {
	...
	webconsoleIframeRender = render.New(render.Options{
		// HTML layout to be used for all HTML requests:
		HTMLLayout: "application.iframe.plush.html",
